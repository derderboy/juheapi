...
import com.derder.model.dto.interfaceinfo.InterfaceInfoAddRequest;
...
import com.derder.model.dto.interfaceinfo.InterfaceInfoUpdateRequest;
...
public class InterfaceInfoController {
    ...
    public BaseResponse<Page<InterfaceInfo>> listInterfaceInfoVOByPage(@RequestBody InterfaceInfoQueryRequest interfaceInfoQueryRequest, HttpServletRequest request) {
    ...
    public BaseResponse<Boolean> onlineInterfaceInfo(@RequestBody IdRequest idRequest, HttpServletRequest request){
        ...
        // 判断该接口是否可以调用
//        com.derder.model.User user = new com.derder.model.User();
//        user.setUsername("test");
//        String username = juHeApiClient.getUsernameByPost(user);
